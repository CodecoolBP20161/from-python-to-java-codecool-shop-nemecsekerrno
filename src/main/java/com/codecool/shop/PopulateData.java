...
public class PopulateData {
    ...
    public static void main(String[] args) throws SQLException {
        ...
        productDataStore.add(new Product("Henry the Hoover - OD", 49.9f, "USD", "Henry, our favourite vacuum cleaner with now over six million in use, available in 4 colours.", tablet, amazon));
